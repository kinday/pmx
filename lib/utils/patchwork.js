...
function patchConstructor(Target, patches) {
  ...
  var staticPropertiesDescriptors = getOwnPropertyDescriptors(Target);
  delete staticPropertiesDescriptors.name;
  delete staticPropertiesDescriptors.prototype;
  Object.defineProperties(Patched, staticPropertiesDescriptors);
